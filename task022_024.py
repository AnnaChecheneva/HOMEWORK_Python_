...
mass_1, mass_2 = set(randint(1, 20) for i in range(int(input('Введите размер первого множества: ')))), set(randint(1, 100) for i in range(int(input('Введите размер второго множества: '))))
print(mass_1)
print(mass_2)
set_ = sorted(mass_1.intersection(mass_2))
print(*set_)
